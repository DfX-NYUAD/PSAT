...
#PBS -e $stderr
cd $outdir
./sle -t -T $fifile -f 0.05 $infile -o ${base}_enc05.bench
./sle -t -T $fifile -f 0.10 $infile -o ${base}_enc10.bench
./sle -t -T $fifile -f 0.25 $infile -o ${base}_enc25.bench
./sle -t -T $fifile -f 0.50 $infile -o ${base}_enc50.bench
""")
